...
def test_get_ancestors(client: TestClient, mock_oak_implementation: OakImpl):
    ...
    mock_oak_implementation.labels.assert_called_with(["ANCESTOR:01", "ANCESTOR:02", "ANCESTOR:03"])
...
def test_get_descendants(client: TestClient, mock_oak_implementation: OakImpl):
    ...
    mock_oak_implementation.labels.assert_called_with(["DESCENDANT:01", "DESCENDANT:02", "DESCENDANT:03"])
